...
//Push button
#define TEST_BUTTON           7                //Test/start push button (low active)
...
const unsigned char Splash_str[] PROGMEM = "FAB SM ";
const unsigned char Version_str[] PROGMEM = "V 0.0";
...
void setup()
{
  ...
  #ifdef DEBUG_PRINT
    Serial.print(X("FAB SM 0.0"));
    lcd_fixed_string(Version_str);               //Print Ardutester Version
    Serial.println();
    Serial.println(X("      By Ajith Kumar M G"));
    Serial.println(X("original version by Markus Reschke,PighiXXX & PaoloP"));
    Serial.println();
    #ifdef BUTTON_INST
